...
import { Sidebar, SidebarContent, SidebarFooter, SidebarHeader, SidebarMenu, SidebarMenuItem, SidebarMenuButton, SidebarGroup, SidebarGroupLabel, SidebarGroupContent, SidebarProvider } from "@/components/ui/sidebar";
...
const DashboardLayout = ({
  ...
  return <SidebarProvider>
      <div className="min-h-screen flex w-full bg-gray-50 dark:bg-gray-900">
        <Sidebar className={`${collapsed ? "w-16" : "w-72"} border-r border-gray-200 shadow-sm bg-white dark:bg-gray-800 dark:border-gray-700 transition-all duration-200`}>
          <SidebarHeader className="p-4 flex items-center justify-between border-b border-gray-200 dark:border-gray-700">
            {!collapsed && <div className="flex items-center gap-2">
                <img src="/lovable-uploads/9148d22a-9c29-4ee3-8fda-b91c5ff530e9.png" alt="ESTIM Logo" className="h-8 w-auto" />
          ...
          <SidebarContent className="pt-6">
            ...
            {/* Dark mode toggle */}
            {!collapsed && <div className="px-4 pt-6 flex items-center gap-3">
          ...
          <SidebarFooter className="p-4 border-t mt-auto border-gray-200 dark:border-gray-700">
            ...
            {collapsed && <Button variant="outline" size="icon" onClick={toggleDarkMode} className="w-full mt-2 justify-center border-gray-200 dark:border-gray-700 text-gray-700 dark:text-gray-300">
