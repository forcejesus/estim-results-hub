      ...
      <div className="space-y-8">
        ...
        <div className="flex flex-col items-center mb-8">
          <div className="flex justify-center mb-4">
            <img src="/lovable-uploads/9148d22a-9c29-4ee3-8fda-b91c5ff530e9.png" alt="ESTIM Logo" className="h-28 w-auto animate-fade-in" />
          </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          {features.map((feature, index) => <Card key={index} className={`hover:shadow-lg transition-all duration-200 hover:translate-y-[-5px] overflow-hidden ${feature.color}`}>
              <div className="flex h-full">
                ...
                <div className="flex-1 p-6 flex flex-col">
                  ...
                  <Button asChild className="w-full bg-white hover:bg-gray-100 text-gray-800 hover:text-gray-900 border border-gray-200 gap-2 mt-auto dark:bg-gray-800 dark:hover:bg-gray-700 dark:text-gray-200 dark:hover:text-gray-100 dark:border-gray-700">
                    <a href={feature.href}>
